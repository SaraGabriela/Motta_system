...
@section('content')
    <h3 class="page-title">@lang('Crear Trabajador')</h3>
    {!! Form::open(['method' => 'POST', 'route' => ['admin.workers.store'], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-2 form-group">
                    {!! Form::label('nombre_del_trabajador', trans('Nombre:').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-2 form-group">
                    {!! Form::label('documento_indentificacion', trans('DNI/Pasaporte').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-2 form-group">
                    {!! Form::label('total_dias_pagado', trans('Total de dias pagados:').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-2 form-group">
                    ...
                    {!! Form::date('fecha_de_ingreso', old('fecha_de_ingreso'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>

...
@section('content')
    <h3 class="page-title">@lang('Crear Seguro Pensiones')</h3>
    {!! Form::open(['method' => 'POST', 'route' => ['admin.pensions.store'], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('variable', old('variable'), ['class' => 'form-control']) !!}
                    <p class="help-block"></p>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('estado', old('estado'), false) !!}
                    <p class="help-block"></p>
